...
Tokens are used as a proof of authentication

- [ ] What steps can you take in your web apps to keep your data secure?

create privat routes protected with tokens from server

- [ ] Describe how web servers work.

Server is a programm, which contains data and functions to control access and managing of this data
